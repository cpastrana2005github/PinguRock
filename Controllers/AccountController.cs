...
namespace PinguRock.Controllers
{
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(string nombreUsuario, string contrasena)
        {
            ...
            // usuario que coincida con el nombre de usuario y la contraseña proporcionados
            ...
            if (usuario != null)
            {
                // si el usuario es encontrado, se inicia sesion
                Session["UsuarioLogueado"] = usuario.NombreUsuario;
                return RedirectToAction("Index", "Proveedor"); // Redirige a una pagina principal despues del login exitoso
            }
            else
            {
